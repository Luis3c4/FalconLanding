...
// Floating social icons dock. Overlays every section of the page (fixed to
// the viewport) except the footer, where it hides via an IntersectionObserver
// watching the <footer> element.
